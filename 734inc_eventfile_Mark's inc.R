...
chambseq <- c(1:7,37:43, 73:79) # update - manual input chamber numbers that will be sampled. 
  # ChambersIDs 24, 60, 96 used for compressed air flush. ChamberIDs 25:36, 61:72 not in use. 

# Chambers to skip:
chambfilt <- c('none') # Change 'none' for chamber numbers e.g. c('38', '26'). Place 'none' if no chambers to be removed. 'none' used as filler, otherwise filtering fails..
